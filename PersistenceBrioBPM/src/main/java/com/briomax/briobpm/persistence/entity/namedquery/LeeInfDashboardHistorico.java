...
/**
 * El objetivo de la Class LeeInfDashboardHistorico.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Jun 9, 2021 9:59:54 PM Modificaciones:
 * @since JDK 1.8
 */
/*
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "leeInfDashboardHistorico",
		procedureName = "SP_LEE_INF_DASHBOARD_HISTORICO",
		parameters = {
		...
		resultClasses = LeeInfDashboardHistorico.class
	)
})*/
@Entity
@Getter
@Setter
@ToString
public class LeeInfDashboardHistorico implements IEntity {
