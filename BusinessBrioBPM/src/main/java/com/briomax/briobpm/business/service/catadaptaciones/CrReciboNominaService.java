...
@Transactional
@Slf4j
public class CrReciboNominaService implements ICrReciboNominaService {

	
	
	@Autowired
	private ICrReciboNominaRepository reciboNominaRepository;
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = reciboNominaRepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
