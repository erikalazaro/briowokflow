...
@Transactional
@Slf4j
public class CrComprobanteCuotasOPService implements ICrComprobanteCuotasOPService {

	
	
	@Autowired
	private ICrComprobanteCuotaOPRepository comprobanteCuotaOPRepository;
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = comprobanteCuotaOPRepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
