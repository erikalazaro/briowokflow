...
import com.briomax.briobpm.transferobjects.catalogs.CrFormatoCuotaOPTO;

public interface ICrFormatoCuotaOPConverter {

	/** Converter Entity to DTO. */
	Function<CrFormatoCuotasOP, CrFormatoCuotaOPTO> converterEntityToDTO = (entity) -> {
		CrFormatoCuotaOPTO to = null;
		if (entity != null) {
			to = CrFormatoCuotaOPTO.builder()
