...
/**
 * El objetivo de la Class BarDataset.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion May 12, 2021 1:44:10 PM Modificaciones:
 * @since JDK 1.8
 */
@Schema(title = "BarDataset.", description = "BarDataset.")
@Getter
@Setter
@ToString
@Builder
...
public class BarDataset implements Serializable {
	...
	/** Serial Version UID. */
	private static final long serialVersionUID = 6730183624619757024L;
	...
	@ArraySchema(schema = @Schema(name = "data", description = "Data.", implementation = BigDecimal.class))
	private BigDecimal[] data;

	/** El atributo o variable type chart. */
