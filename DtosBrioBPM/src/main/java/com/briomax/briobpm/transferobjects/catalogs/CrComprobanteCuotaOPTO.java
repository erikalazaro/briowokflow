...
/**
 * El objetivo de la Class CrComprobanteCuotaOPTO.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Sept 10, 2024 7:14:58 PM Modificaciones:
 * @since JDK 1.8
 */
@Schema(description = "CrComprobanteCuotaOPTO", title = "Comprobante Cuota OP.")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CrComprobanteCuotaOPTO implements ITransferObject {
