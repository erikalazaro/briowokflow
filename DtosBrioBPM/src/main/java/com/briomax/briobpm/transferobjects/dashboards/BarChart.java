...
/**
 * El objetivo de la Class BarChart.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion May 12, 2021 1:42:21 PM Modificaciones:
 * @since JDK 1.8
 */
@Schema(title = "BarChart.", description = "BarChart.", allOf = IGraph.class)
@Getter
@Setter
@ToString
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BarChart implements IGraph, Serializable {
