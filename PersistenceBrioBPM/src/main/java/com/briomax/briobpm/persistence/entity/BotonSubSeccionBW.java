...
/**
 * El objetivo de la Class BotonSubSeccionBW.java es ...
...
@Entity
@Table(name = "BOTON_SUB_SECCION_BW")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BotonSubSeccionBW implements IEntity {
	...
	@EmbeddedId
	private BotonSubSeccionBWPK id;
