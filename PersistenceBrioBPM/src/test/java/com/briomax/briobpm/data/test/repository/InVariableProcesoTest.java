...
/**
 * El objetivo de la Class IInVariableProcesoRepository.java es ...
 * @author Sara Ventura
 * @version 1.0 Fecha de creacion Nov 28, 2023 Modificaciones:
 * @since JDK 1.8
 */
@Slf4j
public class InVariableProcesoTest extends AbstractDataTest {
	 ...
	 */
	@Test
	public void inVariableProcesoAllTest() throws BrioBPMException {
		List<InVariableProceso> list = repository.findAll();
	...
	@Test
	public void inVariableProcesoByIdTest() throws BrioBPMException {
		InVariableProcesoPK id = InVariableProcesoPK.builder()
				...
				.secuenciaValor(1)
				.build();
		Optional<InVariableProceso> result = repository.findById(id );
