...
@Transactional
@Slf4j
public class CrAvisoIcsoeService implements ICrAvisoIcsoeService {

	
	
	@Autowired
	private ICrAvisoICSOERepository avisoICSOERepository;
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = avisoICSOERepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
