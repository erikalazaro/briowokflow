...
@Transactional
@Slf4j
public class CrPagoBancarioService implements ICrPagoBancarioService {

	
	
	@Autowired
	private ICrPagoBancarioRepository pagoBancarioRepository;
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = pagoBancarioRepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
