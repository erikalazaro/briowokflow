...
/**
 * El objetivo de la Class LeeInfDashboardPie.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Jun 7, 2021 6:54:09 PM Modificaciones:
 * @since JDK 1.8
 */
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "leeInfDashboardPie",
		procedureName = "SP_LEE_INF_DASHBOARD_PIE",
		parameters = {
		...
		resultClasses = LeeInfDashboardPie.class
	)
})
@Entity
@Getter
@Setter
@ToString
public class LeeInfDashboardPie implements IEntity {

	/** Serial Version UID. */
	private static final long serialVersionUID = 5928818465772465149L;
