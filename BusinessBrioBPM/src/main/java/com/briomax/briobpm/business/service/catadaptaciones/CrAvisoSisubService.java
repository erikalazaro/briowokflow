...
@Transactional
@Slf4j
public class CrAvisoSisubService implements ICrAvisoSisubService {

	
	
	@Autowired
	private ICrAvisoSISUBRepository avisoSISUBRepository;
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = avisoSISUBRepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
