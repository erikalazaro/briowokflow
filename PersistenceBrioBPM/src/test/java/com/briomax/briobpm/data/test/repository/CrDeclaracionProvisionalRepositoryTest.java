 ...
 */
@Slf4j
public class CrDeclaracionProvisionalRepositoryTest extends AbstractDataTest {

	/** El atributo o variable repository. */
	@Autowired
	private ICrDeclaracionProvisionalRepository repository;
	 ...
	 */
	@Test
	public void crDeclaracionProvisionalAllTest() throws BrioBPMException {
	    List<CrDeclaracionProvisional> list = repository.findAll();
	...
	public void stProcesoId() throws BrioBPMException {
	    CrDeclaracionProvisionalPK id = CrDeclaracionProvisionalPK.builder()
	            .cveEntidad("BRIOMAX")
	            .cveProceso("DUMMY")
	            .build();
	    log.info("----->id: " + id.toString());
	    
	    Optional<CrDeclaracionProvisional> procesoOptional = repository.findById(id);
