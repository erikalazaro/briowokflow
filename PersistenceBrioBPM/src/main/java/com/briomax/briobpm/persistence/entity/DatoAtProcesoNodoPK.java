...
@NoArgsConstructor
@AllArgsConstructor
public class DatoAtProcesoNodoPK implements IPrimaryKey {
	/** Serial Version UID. */
    ...
    @Column(name = "CVE_DATO_PROCESO_NODO", nullable = false, precision = 2, scale = 0)
    private Integer cveDatoProcesoNodo;
