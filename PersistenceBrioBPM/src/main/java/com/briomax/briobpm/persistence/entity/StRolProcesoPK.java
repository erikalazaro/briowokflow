...
/**
 * El objetivo de la Class StRolProcesoPK.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Jun 25, 2020 12:23:23 PM Modificaciones:
 * @since JDK 1.8
 */
@Embeddable
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class StRolProcesoPK implements IPrimaryKey {

	/** Serial Version UID. */
	private static final long serialVersionUID = 437918024679949289L;
