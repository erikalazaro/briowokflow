...
@NoArgsConstructor
@AllArgsConstructor
public class CrProgramacionProcesoPK implements IPrimaryKey {
    ...
    @Column(name = "SECUENCIA_PROGRAMACION", nullable = false, precision = 5, scale = 0)
    private Integer secuenciaProgramacion;
