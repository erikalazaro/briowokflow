...
/**
 * El objetivo de la Class StBotonNodoPK.java es ...
...
@NoArgsConstructor
@AllArgsConstructor
public class StBotonNodoPK implements IPrimaryKey {
	...
	/** El atributo o variable id Nodo*/
	@Column(name = "SECUENCIA_BOTON", nullable = false, precision = 3, scale = 0)
