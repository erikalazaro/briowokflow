...
/*@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "obtenerDocumentosNodo",
		procedureName = "SP_LEE_DOCUMENTOS_NODO",
		parameters = {
		...
		resultClasses = LeeDocumentosNodo.class
	)
})*/
/**
 * El objetivo de la Class LeeDocumentosNodo.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Mar 5, 2020 12:08:14 PM Modificaciones:
 * @since JDK 1.8
 */
@Entity
@Getter
@Setter
@ToString
public class LeeDocumentosNodo implements IEntity {

	/** Serial Version UID. */
	private static final long serialVersionUID = 5175855485939100788L;
