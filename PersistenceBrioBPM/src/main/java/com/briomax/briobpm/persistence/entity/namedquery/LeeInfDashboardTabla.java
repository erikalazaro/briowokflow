...
/**
 * El objetivo de la Class LeeInfDashboardTabla.java es ...
 * @author Rigoberto Olvera
 * @version 1.0 Fecha de creacion Jun 7, 2021 6:55:18 PM Modificaciones:
 * @since JDK 1.8
 */
@NamedStoredProcedureQueries({
	@NamedStoredProcedureQuery(name = "leeInfDashboardTabla",
		procedureName = "SP_LEE_INF_DASHBOARD_TABLA",
		parameters = {
			...
			@StoredProcedureParameter(name = "CH_TOP_SOLICITADO", type = String.class, mode = ParameterMode.IN),
			@StoredProcedureParameter(name = "I_N_TOP", type = Integer.class, mode = ParameterMode.IN),
		...
		resultClasses = LeeInfDashboardTabla.class
	)
})
@Entity
@Getter
@Setter
@ToString
public class LeeInfDashboardTabla implements IEntity {

	/** Serial Version UID. */
	private static final long serialVersionUID = -8879149590578176200L;
