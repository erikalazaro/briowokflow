...
@Transactional
@Slf4j
public class CrCedulaDetCuotasService implements ICrCedulaDetCuotasService {
	...
	public List<ComboBoxTO> getRfcProcesosPeriodicos(DatosAutenticacionTO session, ConsultaPdfTO filtro)
		...
		/*List<String> listRfc = cedulaDetCuotasRepository.getRfc(session.getCveEntidad(), filtro.getFechaIncio(), filtro.getFechaFin(),
				filtro.getTipo());
