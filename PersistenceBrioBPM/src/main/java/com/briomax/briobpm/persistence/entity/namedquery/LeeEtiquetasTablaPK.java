...
/**
 * El objetivo de la Class LeeEtiquetasTablaPK.java es ...
 * @author Rigoberto Olvera C.
 * @version 1.0 Fecha de creacion 4/02/2020 10:33:44 PM Modificaciones:
 * @since JDK 1.8
 */
@Embeddable
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class LeeEtiquetasTablaPK implements IPrimaryKey {

	/** serial Version UID. */
	private static final long serialVersionUID = 848710208886599961L;
