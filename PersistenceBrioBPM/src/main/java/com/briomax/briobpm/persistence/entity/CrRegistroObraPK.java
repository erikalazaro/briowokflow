 ...
 * @author Sara Ventura
 * @version 1.0 Fecha de creacion Sept 03, 2024 12:08:29 PM Modificaciones:
 * @since JDK 1.8
 */
...
@NoArgsConstructor
@AllArgsConstructor
public class CrRegistroObraPK implements IPrimaryKey {
	...
	/** El atributo o variable. */
	@Column(name = "TIPO_PERIODO", nullable = false, length = 15)
