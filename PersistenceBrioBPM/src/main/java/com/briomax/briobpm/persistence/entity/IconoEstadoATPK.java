...
/**
 * El objetivo de la Class IconoEstadoATPK.java es ...
...
@NoArgsConstructor
@AllArgsConstructor
public class IconoEstadoATPK implements IPrimaryKey {
    ...
    @Column(name = "SECUENCIA_ICONO", nullable = false, precision = 2, scale = 0)
    private Integer secuenciaIcono;
