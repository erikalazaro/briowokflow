...
@Repository
public interface ICrDeclaracionProvisionalRepository extends JpaRepository<CrDeclaracionProvisional, CrDeclaracionProvisionalPK>{
	 ...
	 @Query(value = "SELECT * " + 
		 ...
		 List<CrDeclaracionProvisional> getDeclaracionProvisional(@Param("cveEntidad") String cveEntidad,
	    ...
	    void deleteCrDeclaracionProvisional(@Param("cveEntidad") String cveEntidad,
				 @Param("cveProceso") String cveProceso,
				 @Param("rfcContratista") String rfcContratista,
				 @Param("numContrato") String numContrato,
				 @Param("fechaCarga") Date fechaCarga);
	 ...
	 @Query(value = "SELECT * " + 
			    ...
			    "  ORDER BY FECHA_CARGA DESC", nativeQuery = true)
			List<CrDeclaracionProvisional> getDeclaracionProvisionalFiltrado(@Param("cveEntidad") String cveEntidad,
	 ...
	 @Query(value = "SELECT * " + 
			    ...
			    "  AND  SITUACION_CARGA = 'CARGA EXITOSA' " +
			    "  ORDER BY FECHA_CARGA DESC", nativeQuery = true)
			List<CrDeclaracionProvisional> getDeclaracionProvisionalFiltrados(@Param("cveEntidad") String cveEntidad,
			                                                                 @Param("fechaInicio") Date fechaInicio,
			                                                                 @Param("fechaFin") Date fechaFin,
