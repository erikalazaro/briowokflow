...
@NoArgsConstructor
@AllArgsConstructor
public class InVariableProcesoPK implements IPrimaryKey {
	...
	@Column(name = "OCURRENCIA", nullable = false,  precision = 4, scale = 0)
	...
	/** El atributo o variable cve instancia. */
	@Column(name = "SECUENCIA_VALOR", nullable = false, precision = 5, scale = 0)
