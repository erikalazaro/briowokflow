...
/**
 * El objetivo de la Class StReglaValidacionProcesoPK.java es ...
...
@NoArgsConstructor
@AllArgsConstructor
public class StReglaValidacionProcesoPK implements IPrimaryKey {
	...
	@Column(name = "CVE_VALIDACION", nullable = false, length = 40)
	private String cveValidacion;
}
